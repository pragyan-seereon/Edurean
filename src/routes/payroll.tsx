...
import { Briefcase, IndianRupee, Users, FileText, Plus, Download, MoreHorizontal, CheckCircle2, Eye, Trash2, Pencil } from "lucide-react";
import { usePayrollRuns, payrollApi, useEmployees, type PayrollRun } from "@/lib/store";
  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <KpiCard label="TDS Deducted" value={latest ? inr(latest.tds) : "—"} icon={<Briefcase className="h-5 w-5" />} tone="warning" />
      </div>
