...
export const Route = createFileRoute("/parents")({
  head: () => ({ meta: [{ title: "Parents — Scholaris ERP" }] }),
  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <KpiCard label="Total Parents" value="4,820" icon={<Users className="h-5 w-5" />} tone="primary" />
        <KpiCard label="Verified" value="92%" delta={2.1} icon={<Users className="h-5 w-5" />} tone="success" />
        <KpiCard label="Active (30d)" value="3,612" delta={4.4} icon={<Users className="h-5 w-5" />} tone="info" />
        <KpiCard label="No App" value="412" icon={<Users className="h-5 w-5" />} tone="warning" />
      </div>
