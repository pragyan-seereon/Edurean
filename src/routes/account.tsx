        ...
        <TabsContent value="security" className="space-y-5">
          <Card className="border-border/60">
            <CardHeader>
              ...
              <CardDescription>Use a strong password unique to Scholaris.</CardDescription>
            </CardHeader>
          ...
          <Card className="border-border/60">
            ...
            <CardContent className="space-y-2">
              {[
                ...
                { icon: Smartphone, device: "Scholaris iOS App", loc: "New Delhi, IN", ip: "203.0.113.42", current: false, time: "4 hours ago" },
